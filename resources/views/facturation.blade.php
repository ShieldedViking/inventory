...
@section('contenido1')
		   		...
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner desc">
							   <h2 class="heading-section" style="font-size: 100px;">Facturation</h2>
		   				</div>
		   			</div>
		   		</div>
		   	</li>
	...
	<div>
		<br>
		<a href="{{url('facturation/create')}}"><button type="button" class="btn btn-primary btn-lg btn-block">Create new facturation report</button></a>
		<br>
	</div>
@stop