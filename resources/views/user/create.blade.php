...
@section('contenido1')
    ...
    <form method="post" action="{{route('user.store')}}">
        ...
        <label for="confirmar">
            ...
            <input name="confirmar" class="from control" type="confirmar" value="{{old('confirmar')}}">
            {{$errors->first('confirmar')}}
        </label>
        <br>
        <label for="farmacia">
            farmacia
            <input name="farmacia" class="from control" type="farmacia" value="{{old('farmacia')}}">
            {{$errors->first('farmacia')}}
        </label>
        <br>
        <label for="tipo">
            tipo
            <input name="tipo" class="from control" type="tipo" value="{{old('tipo')}}">
            {{$errors->first('tipo')}}
        </label>
        <br>
    ...
    <div class="btn-cta" type="button"><a href="login">Login</a></div>
    </div>
@stop